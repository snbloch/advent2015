        ...
        while num_butterscotch <= 100:
            ...
            while num_sugar <= 100:
                if num_frosting + num_candy + num_butterscotch + num_sugar == 100:
                    ...
                    calories = num_frosting * ingredients['Frosting'][4] + num_candy * ingredients['Candy'][4] + num_butterscotch * ingredients['Butterscotch'][4] + num_sugar * ingredients['Sugar'][4]
                    if capacity < 0:
                        capacity = 0
                    if durability < 0:
                        durability = 0
                    ...
                    if score > high_score and calories == 500:
                        high_score = score
                num_sugar += 1
            num_butterscotch += 1
        num_candy += 1
